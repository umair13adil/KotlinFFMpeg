...
public class AudioTrimmer {
    ...
    private static String TAG = AudioTrimmer.class.getSimpleName();
    ...
    public static AudioTrimmer with(Context context) {
        return new AudioTrimmer(context);
    }

    public AudioTrimmer setFile(File originalFiles) {
        this.audio = originalFiles;
        return this;
    }

    public AudioTrimmer setFormat(AudioFormat format) {
        this.format = format;
        return this;
    }

    public AudioTrimmer setCallback(IConvertCallback callback) {
    ...
    public void trim() {
        ...
        final String[] cmd = new String[]{"-i", audio.getPath(), "-ss", "10", "-t", "6", "-acodec", "copy", outputLocation.getPath()};
    ...
    private static File getConvertedFile() {
        ...
        String path = Environment.getExternalStorageDirectory() + File.separator + "MyImages" + File.separator + timeStamp + "_trimmed.mp3";
